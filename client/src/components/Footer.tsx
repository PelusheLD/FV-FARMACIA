    ...
    <footer className="bg-white dark:bg-card border-t mt-auto">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="font-display font-semibold text-lg mb-4 text-[#29a03b]">Atención al cliente</h3>
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>{settings?.contactEmail || 'contacto@fvfarmacia.com'}</span>
              </div>
              <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="font-display font-semibold text-lg mb-4 text-[#29a03b]">Síguenos</h3>
          ...
          <div>
            <h3 className="font-display font-semibold text-lg mb-4 text-[#29a03b]">Información</h3>
        ...
        <div className="border-t mt-8 pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} {settings?.siteName || 'FV FARMACIA'}. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
